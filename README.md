# CitationCheck - AI Citation Verifier / AI 引文真实性自动化查证工具
...
**CitationCheck** is an automated BibTeX citation verification tool designed for researchers and developers. It effectively identifies "hallucinated citations" generated by Large Language Models (LLMs) and ensures the authenticity and accuracy of citations through cross-verification with multi-source APIs.
