# CitationAIHLNCheck - AI Citation Verifier / AI 引文真实性自动化查证工具
...
**CitationAIHLNCheck** 是一款专为科研人员和开发者设计的 BibTeX 引文自动化查证工具。它能够有效识别由大语言模型（如 ChatGPT）生成的“幻觉文献”，并通过多源 API 交叉验证确保引文的真实性与准确性。
